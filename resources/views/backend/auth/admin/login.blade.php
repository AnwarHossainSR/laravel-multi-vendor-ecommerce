        ...
        <div class="row">
          ...
          <div class="col-lg-6 bg-white">
            ...
            <div class="form d-flex align-items-center">
              <div class="content">
                <form method="POST" action="{{ route('admin.login.check') }}" class="form-validate">
                    @csrf
                  <div class="form-group">
                    <input id="email" type="email" required data-msg="Please enter your email" class="input-material" name="email" value="{{ old('email') }}">
                    <label for="email" class="label-material">Admin Email</label>
                    @error('email')
                  ...
                  <div class="form-group">
                    ...
                    <label for="password" class="label-material">Admin Password</label>
                    @error('password')
                        <span class="text-danger" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
