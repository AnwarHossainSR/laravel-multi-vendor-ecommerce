            ...
            <div class="card mt-5">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <h1 class="display-4"><a href="{{ route('category.create') }}" class="btn btn-secondary text-white p-2"><i class="fa fa-plus" aria-hidden="true"></i> Add Category</a></h1>
                    </div>
                    <table id="table" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="checkbox" name="toggle" value="{{ $category->id }}" data-toggle="switchbutton" {{ $category->status == 'active' ? 'checked':'' }} data-onlabel="active" data-offlabel="inactive"data-size="sm" data-onstyle="success" data-offstyle="danger">
                                </td>
                                <td>
