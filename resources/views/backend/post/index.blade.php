            ...
            <div class="card mt-5">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <h1 class="display-4"><a href="{{ route('post.create') }}" class="btn btn-secondary text-white p-2"><i class="fa fa-plus" aria-hidden="true"></i> Add New Post</a></h1>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    @foreach ($post_tags as $tag)
                                        <li class="badge badge-warning text-dark">{{ $tag }}</li><br/>
                                    @endforeach
                                </td>
                                <td ><a href="" class="text-info">{{ $post->author_info->full_name }}</a></td>
                                <td>
                                    @if($post->photo)
                                ...
                                <td>
                                    <input type="checkbox" name="toggle" value="{{ $post->id }}" data-toggle="switchbutton" {{ $post->status == 'active' ? 'checked':'' }} data-onlabel="active" data-offlabel="inactive"data-size="sm" data-onstyle="success" data-offstyle="danger">
                                </td>
                                <td>
