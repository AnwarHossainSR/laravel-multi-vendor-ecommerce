            ...
            <div class="card mt-5">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <h3 class="display-6">Create Coupon</h3>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                          <div class="form-group-material mt-2">
                            <input id="register-username" type="text" name="code" class="input-material">
                          ...
                          <div class="form-group-material mt-5">
                            <input id="register-username" type="text" name="value" class="input-material">
