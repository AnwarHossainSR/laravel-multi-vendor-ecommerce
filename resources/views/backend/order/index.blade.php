...
<div class="page-content">
	<div class="page-header">
	  <div class="container-fluid">
		<h2 class="h5 no-margin-bottom"><i class="fa fa-home" aria-hidden="true"></i>&nbsp;<a href="{{ route('orders.index') }}">orders</a></h2>
	  </div>
	</div>
            ...
            <div class="card mt-5">
                <div class="card-body"z>
                    <div class="d-flex justify-content-between">
                        <h1 class="display-4">All order</h1>
                        <h1 class="display-4"><a href="{{ route('orders.create') }}" class="btn btn-secondary text-white p-2"><i class="fa fa-plus" aria-hidden="true"></i> Create order</a></h1>
                    </div>
                    <table id="table" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('orders.show',$order->id)}}" class="btn btn-info btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="details" data-placement="bottom"><i class="fa fa-eye"></i></a>
                                    <a href="{{route('orders.edit',$order->id)}}" class="btn btn-success btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fa fa-edit"></i></a>
