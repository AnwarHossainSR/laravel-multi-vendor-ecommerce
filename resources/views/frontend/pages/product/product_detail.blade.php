															...
															<div class="col-12">
																...
																<form class="form" method="POST" action="{{route('review.store')}}">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-12 col-12">
                                                                            <label for="reson">Reson for your rating</label>
																			<div class="form-group">
																				<select class="form-control" name="reason" id="reson">
																		...
																		<div class="col-lg-12 col-12 mt-4">
																			<div class="form-group">
																				...
																				<textarea name="review" rows="3" placeholder="" ></textarea>
																			</div>
																		</div>
																		<div class="col-lg-12 col-12">
																...
																<div class="ratting-main">
																	...
																	<div class="single-rating">
																		...
																		<div class="rating-des">
																			<h6>{{$data->user_info['full_name']}}</h6>
																			<div class="ratings">
																				...
																				<div class="rate-count">(<span>{{$data->rate}}</span>) for {{ $data->reason }}</div>
																			</div>
																			<p>{{$data->review}}</p>
																		</div>
																	</div>
																	<!--/ End Single Rating -->
																	@endforeach
                                                                    {{-- {{ $$product_detail['getReview']->links() }} --}}
																</div>
